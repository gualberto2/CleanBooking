...
function patchModuleLoader(logger, snapshotManager, typescript, lsHost, project, configManager) {
    ...
    const origResolveModuleNamLiterals = (_b = lsHost.resolveModuleNameLiterals) === null || _b === void 0 ? void 0 : _b.bind(lsHost);
    ...
    function resolveModuleNameLiterals(moduleLiterals, containingFile, redirectedReference, options, containingSourceFile, reusedNames) {
        ...
        // Svelte file and if so, are resolved, too. This way we can defer
        // all module resolving logic except for Svelte files to TypeScript.
        const resolved = (_a = origResolveModuleNamLiterals === null || origResolveModuleNamLiterals === void 0 ? void 0 : origResolveModuleNamLiterals(moduleLiterals, containingFile, redirectedReference, options, containingSourceFile, reusedNames)) !== null && _a !== void 0 ? _a : moduleLiterals.map(() => ({
