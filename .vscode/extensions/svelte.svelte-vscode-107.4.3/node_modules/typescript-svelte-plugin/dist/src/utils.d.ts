...
export declare function gatherDescendants<T extends ts.Node>(node: ts.Node, predicate: NodePredicate | NodeTypePredicate<T>, dest?: T[]): T[];
export declare function findIdentifier(ts: _ts, node: ts.Node): ts.Identifier | undefined;
export declare function hasNodeModule(compilerOptions: ts.CompilerOptions, module: string): string | boolean;
export {};
