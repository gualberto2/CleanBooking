...
class CodeActionsProviderImpl {
    ...
    async resolveCodeAction(document, codeAction, cancellationToken) {
        ...
        const fix = lang.getCombinedCodeFix({
            type: 'file',
            fileName: ((_a = virtualDocInfo === null || virtualDocInfo === void 0 ? void 0 : virtualDocInfo.virtualDoc) !== null && _a !== void 0 ? _a : document).getFilePath()
    ...
    async createVirtualDocumentForCombinedImportCodeFix(document, diagnostics, tsDoc, lang) {
        ...
        for (const diagnostic of diagnostics) {
            ...
            const name = identifier === null || identifier === void 0 ? void 0 : identifier.text;
    ...
    fixCombinedImportQuickFix(documentChanges, document, formatCodeBasis) {
        ...
        if (editForThisFile === null || editForThisFile === void 0 ? void 0 : editForThisFile.edits.length) {
    ...
    isQuickFixAllResolveInfo(data) {
        const asserted = data;
        return (asserted === null || asserted === void 0 ? void 0 : asserted.fixId) != undefined && typeof asserted.fixName === 'string';
    }
        ...
        const documentChangesPromises = fix.changes.map(async (change) => {
            ...
            return vscode_languageserver_1.TextDocumentEdit.create(vscode_languageserver_1.OptionalVersionedTextDocumentIdentifier.create((0, utils_1.pathToUrl)(change.fileName), null), change.textChanges
                ...
                if (fix.fixName === FIX_IMPORT_FIX_NAME &&
                    ...
                    const startPos = (_c = namePosition !== null && namePosition !== void 0 ? namePosition : (_b = (_a = this.findDiagnosticForImportFix(document, edit, getDiagnostics())) === null || _a === void 0 ? void 0 : _a.range) === null || _b === void 0 ? void 0 : _b.start) !== null && _c !== void 0 ? _c : vscode_languageserver_1.Position.create(0, 0);
                ...
                if (fix.fixName === 'fixMissingFunctionDeclaration') {
                    ...
                    const checkRange = position
                        ...
                        : (_d = this.findDiagnosticForQuickFix(document, DiagnosticsProvider_1.DiagnosticCode.CANNOT_FIND_NAME, getDiagnostics(), (possiblyIdentifier) => {
                            return edit.newText.includes('function ' + possiblyIdentifier + '(');
                        })) === null || _d === void 0 ? void 0 : _d.range;
    ...
    getComponentImportQuickFix(document, lang, tsDoc, userPreferences, diagnostics, formatCodeSetting) {
        ...
        for (const [name, position] of nameToPosition) {
            ...
            const toFix = (c) => {
                var _a, _b;
                return (_b = (_a = c.codeActions) === null || _a === void 0 ? void 0 : _a.map((a) => ({
                    ...a,
            ...
            const entries = completion === null || completion === void 0 ? void 0 : completion.entries.filter((c) => c.name === name || c.name === (0, utils_2.toGeneratedSvelteComponentName)(name)).map(resolvedCompletion).sort((a, b) => {
                var _a, _b;
                return this.numberOfDirectorySeparators(typescript_1.default.displayPartsToString((_a = a === null || a === void 0 ? void 0 : a.sourceDisplay) !== null && _a !== void 0 ? _a : [])) -
                    this.numberOfDirectorySeparators(typescript_1.default.displayPartsToString((_b = b === null || b === void 0 ? void 0 : b.sourceDisplay) !== null && _b !== void 0 ? _b : []));
            }).filter(utils_1.isNotNullOrUndefined);
    ...
    getSvelteQuickFixes(lang, document, cannotFindNameDiagnostics, tsDoc, formatCodeBasis, userPreferences, formatCodeSettings) {
        ...
        for (const diagnostic of cannotFindNameDiagnostics) {
            ...
            const isQuickFixTargetTargetStore = identifier === null || identifier === void 0 ? void 0 : identifier.escapedText.toString().startsWith('$');
            const fixes = [];
