...
function getConfig() {
    ...
    return ((_a = vscode_1.workspace
        ...
        .get('enable')) !== null && _a !== void 0 ? _a : 'auto');
}
async function detect(nrRetries) {
    ...
    for (const fileUri of packageJsonList) {
        try {
            ...
            const hasKit = Object.keys((_a = pkg.devDependencies) !== null && _a !== void 0 ? _a : {})
                .concat(Object.keys((_b = pkg.dependencies) !== null && _b !== void 0 ? _b : {}))
