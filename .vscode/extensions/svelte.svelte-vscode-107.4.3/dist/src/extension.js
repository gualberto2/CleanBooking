...
function deactivate() {
    const stop = lsApi === null || lsApi === void 0 ? void 0 : lsApi.getLS().stop();
    lsApi = undefined;
    return stop;
}
...
function addRenameFileListener(getLS) {
    vscode_1.workspace.onDidRenameFiles(async (evt) => {
        ...
        vscode_1.window.withProgress({ location: vscode_1.ProgressLocation.Window, title: 'Updating Imports..' }, async () => {
            ...
            const edits = (_a = editsForFileRename === null || editsForFileRename === void 0 ? void 0 : editsForFileRename.documentChanges) === null || _a === void 0 ? void 0 : _a.filter(vscode_languageclient_1.TextDocumentEdit.is);
            if (!edits) {
                return;
            }
